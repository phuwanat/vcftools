...
void variant_file::output_discordance_by_site(const parameters &params, variant_file &diff_variant_file)
{
	...
	diffsites << "CHROM\tPOS\tFILES\tREF\tALT\tMATCHING_ALLELES\tN_COMMON_CALLED\tN_DISCORD\tDISCORDANCE\tN_MATCHED_RR\tN_MATCHED_AA\tNRD" << endl;
	...
	while(true)
	{
		...
		double nrd = N_discord  double(N_common_called - N_concord_non_missing_nonRR);
